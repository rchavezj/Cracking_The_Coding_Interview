...
string BSTree::inOrderPath(*BSTNode root){
	string lChild = inOrderPath(root->left);
	string rChild = inOrderPath(root->right);
	

}

string BSTree::preOrderPath(*BSTNode root){
	string preOrderPath(root->left);
	string preOrderPath(root->right);
}
